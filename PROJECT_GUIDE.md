...
4. [TPASS 方案與運具規則](#tpass-方案與運具規則)
5. [計價與折抵流程](#計價與折抵流程)
6. [ViewModel 層](#viewmodel-層)
7. [Service 層](#service-層)
8. [View 層](#view-層)
9. [主題與通知系統](#主題與通知系統)
10. [備份、還原與匯入匯出](#備份還原與匯入匯出)
11. [遷移與相容策略](#遷移與相容策略)
12. [測試現況與建議](#測試現況與建議)
...
**檔案**：`Services/TPEMRTFareService.swift`、`TRAFareService.swift`、`THSRFareService.swift`、`TYMRTFareService.swift`、`TCMRTFareService.swift`、`KMRTFareService.swift`
