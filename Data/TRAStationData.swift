...
class TRAStationData {
    ...
    private var rawRegions: [TRARegion] {
        return [
            ...
            createRegion(id: "R5", name: "屏東線（高雄-枋寮）", stationNames: [
                "高雄", "民族", "科工館", "正義", "鳳山", "後庄", "九曲堂", "六塊厝", "屏東", "歸來", "麟洛", "西勢", "竹田", "潮州", "崁頂", "南州", "鎮安", "林邊", "佳冬", "東海", "枋寮"
            ]),
            ...
            createRegion(id: "R7", name: "北迴線（蘇澳新-花蓮）", stationNames: [
                "蘇澳新", "永樂", "東澳", "南澳", "武塔", "漢本", "和平", "和仁", "崇德", "新城", "景美", "北埔", "花蓮"
            ]),
            
            createRegion(id: "R8", name: "花東線（花蓮-台東）", stationNames: [
                "臺東", "山里", "鹿野", "瑞源", "瑞和", "關山", "海端", "池上", "富里", "東竹", "東里", "玉里", "三民", "瑞穗", "富源", "大富", "光復", "萬榮", "鳳林", "南平", "林榮新光", "豐田", "壽豐", "平和", "志學", "吉安", "花蓮"
            ]),
            
            createRegion(id: "R9", name: "南迴線（枋寮-台東）", stationNames: [
                "枋寮", "加祿", "內獅", "枋山", "枋野", "大武", "瀧溪", "金崙", "太麻里", "知本", "康樂", "臺東"
            ]),
            
            createRegion(id: "R10", name: "平溪/深澳線", stationNames: [
                "海科館", "八斗子", "瑞芳",  "猴硐", "三貂嶺", "大華", "十分", "望古", "嶺腳", "平溪", "菁桐"
            ]),
            
            createRegion(id: "R11", name: "內灣/六家線", stationNames: [
                "新竹", "北新竹", "千甲", "新莊", "竹中", "六家", "上員", "榮華", "竹東", "橫山", "九讚頭", "合興", "富貴", "內灣"
            ]),
            
            createRegion(id: "R12", name: "集集線", stationNames: [
                "二水", "源泉", "濁水", "龍泉", "集集", "水里", "車埕"
            ]),
            
            
            createRegion(id: "R13", name: "沙崙線", stationNames: [
                "中洲", "長榮大學", "沙崙"
            ])
        ]
    }
    ...
    private let regionNameENByZH: [String: String] = [
        ...
        "屏東線（高雄-枋寮）": "Pingtung Line (Kaohsiung-Fangliao)",
        "宜蘭線 (八堵-蘇澳)": "Yilan Line (Badu–Su'ao)",
        "平溪/深澳線": "Pingxi / Shen'ao Line",
        "內灣/六家線": "Neiwan / Liujia Line",
        "集集線": "Jiji Line",
        "北迴線（蘇澳新-花蓮）": "N.-Link Line (Su'aoxin-Hualian)",
        "花東線（花蓮-台東）": "East Line (Hualian-Taitung)",
        "南迴線（枋寮-台東）": "S.-Link Line (Fangliao-Taitung)",
        "沙崙線": "Shalun Line",
