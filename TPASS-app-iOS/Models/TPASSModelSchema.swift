...
enum TPASSSchemaV2: VersionedSchema {
    ...
    final class Trip {
        ...
        init(id: String, userId: String, createdAt: Date, type: TransportType, originalPrice: Int, paidPrice: Int, isTransfer: Bool, isFree: Bool, startStation: String, endStation: String, routeId: String, note: String, transferDiscountType: TransferDiscountType? = nil, cycleId: String? = nil) {
            self.id = id
            self.userId = userId
            self.createdAt = createdAt
            self.type = type
...
enum TPASSMigrationPlan: SchemaMigrationPlan {
    ...
    static var stages: [MigrationStage] {
        [
            .custom(fromVersion: TPASSSchemaV1.self, 
                   toVersion: TPASSSchemaV2.self,
