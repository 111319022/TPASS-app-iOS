...
- `Services/VoiceParseLogService.swift`
    - 匿名上傳語音解析修正資料到 CloudKit Public Database（Record Type: `VoiceParseLog`）
...
如果你要改語音功能，建議優先從 `VoiceQuickTripView` 與 `TripVoiceParser` 開始追。
